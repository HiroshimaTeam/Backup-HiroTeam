...
---
### About
[ENG] This is a [PocketMine-MP](https://github.com/pmmp/PocketMine-MP) (or forks) plugin to allows to make a backup in plugin_data/Backup-HiroTeam by compressing it in tar.gz :grin:<br/><br/>
[FRA] C'est un [PocketMine-MP](https://github.com/pmmp/PocketMine-MP) plugin qui permet de compresser en tar.gz son serveur en entier dans plugin_data/Backup-HiroTeam :grin:

---
### How to use
[ENG] Use the command /backup and wait</br>

[FRA] Faire la commande /backup et patienter</br>
